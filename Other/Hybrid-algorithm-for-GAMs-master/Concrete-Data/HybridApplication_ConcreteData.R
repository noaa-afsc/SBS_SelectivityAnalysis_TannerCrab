...
for (i in 1:runnumber) {
  ...
  vege<-Sys.time()
  futasido<-vege-eleje
  eredmenyek[i,1]=best[1];#--covariate indices
  eredmenyek[i,2]=best[2];#--R-square
