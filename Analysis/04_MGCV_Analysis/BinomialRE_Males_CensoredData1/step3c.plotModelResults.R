...
device = "png";
pltctr = 1;
plotFN<-function(n,dev=device){paste0("plots3c_males_",wtsUtilities::formatZeros(n),".",dev)}
...
ggsave(paste0("plot3b_males_DiagnosticPlots.",device),plot=pg,width=8,height=5);
