#--fit various models for logit-scale proportions p using mgcv to fit GAMs for males using the BINOMIAL distribution----
require(DHARMa);
require(dplyr);
require(ggplot2);
require(gratia)
...
if (FALSE){
  ...
  # mdlsmths  = gratia::smooths(mdl_ZE2D);
