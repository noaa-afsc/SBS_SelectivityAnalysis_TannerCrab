#--compare female selectivity curves
require(DHARMa);
require(dplyr);
require(ggplot2);
require(gratia)
...
#--get models
paths = list(Binomial="rda_Step3b3.BinomialModels_BestModel.RData",
             Tweedie ="rda_Step3b3.LnTweedieModels_BestModel.RData",
...
#--get base selectivity estimates
lstPrd = list();
